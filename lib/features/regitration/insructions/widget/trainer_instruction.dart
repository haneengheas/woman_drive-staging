    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            '١-  يجب على مستخدم التطبيق  إعطاء معلومات صحيحة وقابلة للاستخدام , وليس بها أي تزوير و يعتبر المستخدم هو المسئول الوحيد عن كافة المعلومات الخاصة بالحجز أو استخدام التطبيق.',
            style: AppTextStyles.name,
            textDirection: TextDirection.rtl,
          ),
          Text(
          ...
          Text(
            '٤- في حال قيام المستخدم بعمل أي حجز لدى تطبيق قيادة المرأه  ، سيقوم التطبيق بحفظ المعلومات الكافية لإتمام عملية الحجز، ولا يحتاج العميل لإدخال هذه المعلومات في كل مرة يقوم خلالها بالحجز',
            style: AppTextStyles.name,
            textDirection: TextDirection.rtl,
          ),
          Text(
            '٥- في حال قيام المستخدم بمحاولة تعطيل او الاضرار بتطبيق ، يحق للتطبيق إلغاء الحساب الخاص بالمستخدم بشكل كلي ، وتقديم بلاغ رسمي للجهات المختصة ',
            style: AppTextStyles.name,
            textDirection: TextDirection.rtl,
          ),
          Text(
          ...
          Text(
            '١٣ -يجب أن تكون التقييمات صادقة وغير كاذبة وبعبارات ملائمة وأن يبتعد العميل عن الإساءة للمدربين  أو استخدام العبارات غير اللائقة.',
            style: AppTextStyles.name,
            textDirection: TextDirection.rtl,
          ),
          Text(
